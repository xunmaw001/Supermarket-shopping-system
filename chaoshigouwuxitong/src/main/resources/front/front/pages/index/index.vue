<template>
    <view class="uni-padding-wrap">
        ...
        <view class="menu" style="display: flex;flex-wrap: wrap;justify-content: space-around"
            ...
            <block>
                <block>
                    <block>
                        <block>
                            <view :style='{"padding":"10rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(244, 245, 244, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"12rpx","borderWidth":"2rpx","width":"19%","borderStyle":"solid","height":"150rpx"}'
                                   class="menu-list" @tap="onPageTap2('../shangpin/list',1)">
							...
							<view :style='{"padding":"10rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(244, 245, 244, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"12rpx","borderWidth":"2rpx","width":"19%","borderStyle":"solid","height":"150rpx"}'
								   class="menu-list" @tap="onPageTap2('../shangpin/list',2)">
							...
							<view :style='{"padding":"10rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(244, 245, 244, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"12rpx","borderWidth":"2rpx","width":"19%","borderStyle":"solid","height":"150rpx"}'
								   class="menu-list" @tap="onPageTap2('../shangpin/list',3)">
							...
							<view :style='{"padding":"10rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(244, 245, 244, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"12rpx","borderWidth":"2rpx","width":"19%","borderStyle":"solid","height":"150rpx"}'
								   class="menu-list" @tap="onPageTap2('../shangpin/list',4)">
							...
							<view :style='{"padding":"10rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(244, 245, 244, 1)","backgroundColor":"var(--publicSubColor)","borderRadius":"12rpx","borderWidth":"2rpx","width":"19%","borderStyle":"solid","height":"150rpx"}'
								   class="menu-list" @tap="onPageTap2('../shangpin/list',5)">
